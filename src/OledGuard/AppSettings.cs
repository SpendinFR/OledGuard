...
public sealed class AppSettings
{
    ...
    public int DarkenFadeMilliseconds { get; set; } = 2200;
    ...
    public void Migrate()
    {
        ...
        // v12 restores the original fine pixel-gradient engine. It keeps the smooth
        // mouse trail and filters one-sample flicker that created bright stains.
        CellSizePixels = 16;
        SamplesPerCell = 3;
        VisibleSamplingMilliseconds = 1000;
        MaskedSamplingMilliseconds = 250;
        DarkenFadeMilliseconds = 2200;
