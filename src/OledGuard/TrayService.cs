...
{
    private readonly ProtectionController
        _controller;
    private readonly Forms.NotifyIcon
        _notifyIcon;
    private readonly Forms.ToolStripMenuItem
        _enabledItem;
        ...
        ProtectionController controller)
    {
        ...
        var delayMenu =
            new Forms.ToolStripMenuItem(
                "Maintien d'une zone animée");

        foreach (var seconds in
                 new[]
                 {
                     10,
                     15,
        ...
        if (!_controller
                 .CaptureExclusionAvailable)
        {
            _notifyIcon.ShowBalloonTip(
                8000,
                "OledGuard — vérification requise",
                "Windows n'a pas confirmé l'exclusion du masque des captures.",
    ...
    private void RefreshMenu()
    {
        ...
        _notifyIcon.Text =
            _controller.Enabled
                ? $"OledGuard actif — zones {activeSeconds} s"
                : "OledGuard désactivé";
    }
